    ...
    <nav className="bg-white shadow-lg fixed w-full top-0 z-50 border-b-2 border-yellow-400">
      <div className="container mx-auto px-6 py-3 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-6">
          <Link to="/home" className={`pb-1 ${location.pathname === '/home' ? 'border-b-4 border-yellow-500 text-yellow-700' : 'text-gray-700 hover:text-yellow-700'}`}>Home</Link>
      ...
      {menuOpen && (
        <div className="md:hidden bg-white shadow-md absolute top-full left-0 w-full py-4">
          <Link to="/home" className="block px-6 py-2 text-gray-700 hover:bg-gray-100">Home</Link>
